...
#Test Template tells DataDriver which keyword to execute for each row in data.csv
Test Template    Browser unsuccessful Login
...
*** Test Cases ***
#if we have test cases column blank in the csv file, then the below test case will be considered to be executed as default
Logging in with user ${username} and password ${password}
    #[Arguments]    ${username}=rahulshett    ${password}=12345
